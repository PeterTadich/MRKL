...
console.log(thetalistNext);
console.log(dthetalistNext);
*/

function EulerStep(thetalist, dthetalist, ddthetalist, dt){
    var thetalistNext = matrix_arithmetic(thetalist,matrix_multiplication_scalar(dthetalist,dt),"+");
    var dthetalistNext = matrix_arithmetic(dthetalist,matrix_multiplication_scalar(ddthetalist,dt),"+");

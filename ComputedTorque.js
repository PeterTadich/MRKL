...
var thetalistd = [[1],[1],[1]];
var dthetalistd = [[2],[1.2],[2]];
var ddthetalistd = [[0.1],[0.1],[0.1]];
var Kp = 1.3;
var Ki = 1.2;
var Kd = 1.1;
var taulist = ComputedTorque(thetalist, dthetalist, eint, g, Mlist, Glist, Slist, thetalistd, dthetalistd, ddthetalistd, Kp, Ki, Kd);
print_matrix(taulist);
*/

function ComputedTorque(thetalist, dthetalist, eint, g, Mlist, Glist, Slist, thetalistd, dthetalistd, ddthetalistd, Kp, Ki, Kd){
    var e = matrix_arithmetic(thetalistd,thetalist,"-");
    var MM; var Fi;
    [MM,Fi] = MassMatrix(thetalist, Mlist, Glist, Slist);
    var tau;
    [tau,Fi] = InverseDynamics(thetalist, dthetalist, ddthetalistd, g, zeros_matrix(6, 1), Mlist, Glist, Slist);
    var taulist = matrix_arithmetic(
                        matrix_multiplication(
                            MM,
                            matrix_arithmetic(
                                matrix_multiplication_scalar(e,Kp),
                                matrix_arithmetic(
                                    matrix_multiplication_scalar(matrix_arithmetic(eint,e,"+"),Ki),
                                    matrix_multiplication_scalar(matrix_arithmetic(dthetalistd,dthetalist,"-"),Kd),
                                    "+"
                                ),
                                "+"
                            )
                        ),
                        matrix_transpose([tau]),
                        "+"
                  );
    return taulist;
}

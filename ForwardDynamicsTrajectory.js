...
var dt = 0.1;
var intRes = 8;
var thetamat; var dthetamat;
[thetamat, dthetamat] = ForwardDynamicsTrajectory(thetalist, dthetalist, taumat, g, Ftipmat, Mlist, Glist, Slist, dt, intRes);
print_matrix(thetamat);
print_matrix(dthetamat);
*/

function ForwardDynamicsTrajectory(thetalist, dthetalist, taumat, g, Ftipmat, Mlist, Glist, Slist, dt, intRes){
    //taumat = taumat';
    //Ftipmat = Ftipmat';
    var thetamat = [];
    ...
    for(var i=0;i<(taumat.length-1);i=i+1){
        for(var j=0;j<intRes;j=j+1){
            var ddthetalist= ForwardDynamics(thetalist, dthetalist, taumat[i], g, Ftipmat[i], Mlist, Glist, Slist);     

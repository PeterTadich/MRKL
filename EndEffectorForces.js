...
[JTFtip,generalized] = EndEffectorForces(thetalist, Ftip, Mlist, Glist, Slist);
console.log(JTFtip);
*/

function EndEffectorForces(thetalist, Ftip, Mlist, Glist, Slist){
    var JTFtip; var generalized;
    var n = thetalist.length;
    [JTFtip,generalized] = InverseDynamics(
                        thetalist,
